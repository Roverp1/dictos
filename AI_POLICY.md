...
The Dictos project has strict rules for AI usage:
...
- **Issues and discussions can use AI assistance but must have a full
  ...
  trim this down. Current documentation is generated fully with AI,
  with light editing. As project grows - documentation will need
  to be rewritten, to _trim down the noise_.

These rules apply only to outside contributions to Dictos. Maintainers
...
Please remember that Dictos is maintained by humans.
...
Dictos is written with plenty of AI assistance, and many maintainers embrace
